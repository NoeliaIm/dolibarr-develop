...
/**
 *	\file       htdocs/mimodulo/template/mimoduloindex.php
 *	\ingroup    mimodulo
 *	\brief      Home page of mimodulo top menu
 */
...
$langs->loadLangs(array("mimodulo@mimodulo"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->mimodulo->read) accessforbidden();
...
llxHeader("",$langs->trans("mimoduloArea"));

print load_fiche_titre($langs->trans("mimoduloArea"),'','mimodulo.png@mimodulo');
...
// Draft MyObject
if (! empty($conf->mimodulo->enabled) && $user->rights->mimodulo->read)
{
	$langs->load("orders");
